...
console.log("/opt/web/hpinetdb/hpinetbackend/src/gosemsim/goSemSim.py", "--hgenes", host_genes2, "--pgenes", pathogen_genes, "--host", hspecies, "--pathogen", pspecies, "--method", method, "--score", score, "--t", threshold )
    ...
    getS = spawn('/opt/miniconda3/envs/ml-gpu/bin/python3', ["/home/dock_user/web/hpinetdb/hpinetbackend/src/gosemsim/goSemSim.py", "--hgenes", host_genes2, "--pgenes", pathogen_genes, "--host", hspecies, "--pathogen", pspecies, "--method", method, "--score", score, "--t", threshold]);
