  ...
  if(!body.page){
   ...
   if (body.page){
    ...
    if (body.genes.length===0) {
      ...
      host_protein = await Results.distinct("Host_Protein", {'intdb':{'$in':body.intdb}}).count()
      pathogen_protein =await Results.distinct('Pathogen_Protein', {'intdb':{'$in':body.intdb}}).count()
